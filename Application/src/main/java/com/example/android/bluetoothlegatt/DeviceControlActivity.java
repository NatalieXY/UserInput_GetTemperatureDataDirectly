                ...
                public boolean onChildClick(ExpandableListView parent, View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if (characteristic.getUuid().equals(UUID.fromString(SampleGattAttributes.TEMPERATURE_MEASUREMENT)))
                        {
                            ...
                            intent.putExtra("character_id", characteristic.getUuid().toString());
                            intent.putExtra("servic_id", characteristic.getService().getUuid().toString());
                            intent.putExtra("address", mDeviceAddress);
                            startActivity(intent);
                        }
                        //------------------------------------------------------

                        else if (characteristic.getUuid().equals(UUID.fromString(SampleGattAttributes.CTRL_2)))
                        {
                            Intent intent = new Intent(DeviceControlActivity.this, CtrlControlActivity.class);
                            intent.putExtra("character_id", characteristic.getUuid().toString());
                            intent.putExtra("servic_id", characteristic.getService().getUuid().toString());
                            intent.putExtra("address", mDeviceAddress);
                            startActivity(intent);
